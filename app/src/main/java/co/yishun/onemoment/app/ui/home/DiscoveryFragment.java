 ...
 */
@EFragment
public class DiscoveryFragment extends TabPagerFragment implements AbstractRecyclerViewAdapter.OnItemClickListener<WorldTag> {
    ...
    protected int getTabTitleArrayResources() {
        return R.array.discovery_page_title;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.fragment_discovery_action_search:
